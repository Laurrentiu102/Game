...
public class TreeGenerator : EditorWindow
{
    ...
    [Range(0, 2)] public int smoothingPower = 1;
    ...
    private void OnGUI()
    {
        if (!trunkMaterial) trunkMaterial = AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/Trunk.mat");
        if (!leavesMaterial) leavesMaterial = AssetDatabase.LoadAssetAtPath<Material>("Assets/Materials/Leaves.mat");
