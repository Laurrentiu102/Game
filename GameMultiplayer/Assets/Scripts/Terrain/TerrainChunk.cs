...
public class TerrainChunk {
	...
	public TerrainChunk(Vector2 coord, HeightMapSettings heightMapSettings, MeshSettings meshSettings, LODInfo[] detailLevels, int colliderLODIndex, Transform parent, Transform viewer, Material material,TextureData textureData) {

		CorutineForChunks.instance.StartCoroutine(FunctionAux(coord,heightMapSettings, meshSettings, detailLevels,
			colliderLODIndex, parent, viewer, material, textureData));
...
*/
	...
	public void Load() {
		ThreadedDataRequester.RequestData(() => HeightMapGenerator.GenerateHeightMap (meshSettings.numVertsPerLine, meshSettings.numVertsPerLine, heightMapSettings, sampleCentre, coord), OnHeightMapReceived);
	}
	...
	void OnHeightMapReceived(object heightMapObject) {
		...
		water.transform.localPosition =  new Vector3( 0f,30*0.14f,0f);
		Vector3 newSize = water.transform.localScale *12.2f;
		newSize.y = 1;
		water.transform.localScale = newSize;
